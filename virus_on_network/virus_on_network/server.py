...
model_params = {
    "number_asian": UserSettableParameter(
        "slider",
        "Number of Asian Agents",
        10,
        10,
        100,
        1,
        description="Choose how many asian agents to be included in the model",
    ),
    "number_white": UserSettableParameter(
        "slider",
        "Number of White Agents",
        10,
        10,
        100,
        1,
        description="Choose how many white agents to be included in the model",
    ),
    "number_black": UserSettableParameter(
        "slider",
        "Number of Black Agents",
        10,
        10,
        100,
        1,
