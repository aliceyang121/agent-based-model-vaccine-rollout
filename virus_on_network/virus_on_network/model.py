...
def asian_infected(model):
    return number_state(model, State.ASIAN_INFECTED)

def white_infected(model):
    return number_state(model, State.WHITE_INFECTED)
...
class VirusAgent(Agent):
    ...
    #        self.try_gain_resistance()
            ...
            # Failed
            if self.race == 'asian':
                self.state = State.ASIAN_INFECTED
